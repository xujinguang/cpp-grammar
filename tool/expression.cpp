...
void postfix_expression(int tab, leaf_t &leaf)
{
	leaf_t new_leaf, tmp_leaf;
	TAB_FUNCTION(tab);
	...
	postfix_expression(tab + 2, new_leaf);
	push_back(new_leaf, L_BRACKET);
	expression(tab + 2, new_leaf);
	push_back(new_leaf, R_BRACKET);
	insert(tmp_leaf, new_leaf);
...
void pm_expression(int tab, leaf_t &leaf)
{
	leaf_t new_leaf, tmp_leaf;
	TAB_FUNCTION(tab);
...
void multiplicative_expression(int tab, leaf_t &leaf)
{
	leaf_t new_leaf, tmp_leaf;
	TAB_FUNCTION(tab);
	...
	multiplicative_expression(tab + 2, new_leaf);
	push_back(new_leaf, ASTERISK);
	pm_expression(tab + 2, new_leaf);
	insert(tmp_leaf, new_leaf);
...
void additive_expression(int tab, leaf_t &leaf)
{
	leaf_t new_leaf, tmp_leaf;
	TAB_FUNCTION(tab);
	...
	additive_expression(tab + 2, new_leaf);
	push_back(new_leaf, ADD);
	multiplicative_expression(tab + 2, new_leaf);
	insert(tmp_leaf, new_leaf);
...
void shift_expression(int tab, leaf_t &leaf)
{
	leaf_t new_leaf, tmp_leaf;
	TAB_FUNCTION(tab);
	...
	shift_expression(tab + 2, new_leaf);
	push_back(new_leaf, LSHIFT);
	additive_expression(tab + 2, new_leaf);
	insert(tmp_leaf, new_leaf);
...
void relational_expression(int tab, leaf_t &leaf)
{
	leaf_t new_leaf, tmp_leaf;
	TAB_FUNCTION(tab);
	...
	relational_expression(tab + 2, new_leaf);
	push_back(new_leaf, LESS);
	shift_expression(tab + 2, new_leaf);
	insert(tmp_leaf, new_leaf);
...
void equality_expression(int tab, leaf_t &leaf)
{
	leaf_t new_leaf, tmp_leaf;
	TAB_FUNCTION(tab);
	...
	equality_expression(tab + 2, new_leaf);
	push_back(new_leaf, EQUAL);
	relational_expression(tab + 2, new_leaf);
	insert(tmp_leaf, new_leaf);
